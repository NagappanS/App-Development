        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            <div className="footer-links">
              ...
              <Link to={"/cakesec"} className="footer-link">Cakes</Link>
              <Link to={"/decorates"} className="footer-link">Decorables</Link>
              <Link to={"/eco-Plan"} className="footer-link">Eco-Friendly Plan</Link>
            </div>
          </Grid>
